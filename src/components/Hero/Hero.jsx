    ...
    <>
      ...
      >
        <div
          ...
          className="dcdc parallax-bg absolute left-0 right-0 w-[130%] h-[100%] bg-center bg-cover"
          style={{
            'background-image':
        ...
        ></div>
        <SwiperSlide>
          <div className="title text-center text-9xl font-bold  m-auto text-white max-md:text-8xl w-[80%] h-[50%] " data-swiper-parallax="-300">
